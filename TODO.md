...
> 優先級：§2 地圖紅警（高，實作中：執行順序 1–3 ✅、下一步 4 觀測層）＞ §6 停班停課板塊（中高，待實作）＞ §10 零星災情縣市分組寫法（中低，待選定 A/B）＞ §3 ja 移除／§5 分享按鈕（低）；§1 RSS 已完成（關鍵詞微調＝隨事件維護，非待辦）；§8 cbph 503、§9 颱風卡排序、§11 AI bot 可偵測性均已合併 main 並上線。
